/**
 * Founder Easy Route (Seed Round) — 창업자 루트 EASY
 * 기존 시나리오 기반, 페널티 70% 수준으로 완화
 * 챕터 1-2는 워밍업. 챕터 3-4부터 진짜 시작.
 */
const FounderEasyScenarios = [
    ...
    events: [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            text: '피그마 (예쁘게)',
            effects: { runway: -0.5, mental: -4, persuasion: 10 },
            result: '1주를 태웠다. 디자이너 비용도 좀 들었다.\n\n예쁘긴 하다. 첫인상에서 확실히 유리할 것이다.',
            flags: ['deck_figma'],
          },
          {
            text: '노션 (빠르게)',
            effects: { mental: 5, persuasion: -4 },
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            effects: { persuasion: -11, mental: -6 },
            result: '미팅이 12분 만에 끝났다. 악수도 없이.\n\n엘리베이터에서 눈물이 나왔다.',
            flags: ['no_data'],
          },
          {
            text: '"저희는 PMF 전이라 성장에 집중-"',
            effects: { persuasion: -4, mental: -2 },
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            result: null,
            flags: ['pitch_vision'],
            statCheck: { stat: 'mental', threshold: 55, successFlag: 'passed_ic', failFlag: 'failed_ic' },
          },
          {
            text: 'FOMO (다른 VC 언급)',
            effects: {},
          ...
          },
          {
            ...
            result: null,
            flags: ['pitch_honest'],
            statCheck: { type: 'combined', stats: ['persuasion', 'mental'], threshold: 95, successFlag: 'passed_ic', failFlag: 'failed_ic' },
          },
        ],
        condition: null,
      },
