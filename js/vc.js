    ...
    events: [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            text: '그냥 80억에 투자',
            effects: { powder: -10, bossGaze: -10 },
            result: 'GP: "Pre 80억? 이 스테이지에? 미쳤어?"\n\n좋은 프로덕트에 비싼 값을 치렀다. 맞는 판단이었는지는 3년 후에 안다.',
            resultSpeaker: { name: 'GP 이대표', emoji: '👔' },
            flags: ['invested_80'],
          },
          {
        ...
        choices: [
          {
            ...
            result: null,
            flags: ['ic_data'],
            statCheck: { stat: 'eye', threshold: 60, successFlag: 'vc_passed_ic', failFlag: 'vc_failed_ic' },
          },
          {
            ...
            result: null,
            flags: ['ic_fomo'],
            statCheck: { stat: 'bossGaze', threshold: 50, successFlag: 'vc_passed_ic', failFlag: 'vc_failed_ic' },
          },
          {
            text: '"제가 확신합니다" (소신)',
            effects: {},
            result: null,
            flags: ['ic_conviction'],
            statCheck: { type: 'combined', stats: ['eye', 'bossGaze'], threshold: 100, successFlag: 'vc_passed_ic', failFlag: 'vc_failed_ic' },
          },
        ],
        condition: null,
      },
      // 투심위 통과 시
      {
        ...
        choices: [
          ...
          },
          {
            ...
            effects: { bossGaze: 10 },
            result: 'GP: "좋아, 이래야지"\n\n하지만 대표의 표정이 좋지 않다. 50% 확률로 딜이 깨질 수 있다.',
            resultSpeaker: { name: 'GP 이대표', emoji: '👔' },
            flags: ['termsheet_aggressive'],
            probabilityCheck: { successRate: 0.5, successFlag: 'deal_closed', failFlag: 'deal_rejected' },
          },
          {
            text: '창업자 친화적 (느슨한 조건)',
            effects: { bossGaze: -10 },
            result: 'GP: "왜 이렇게 풀어줘?"\n\n대표가 감동했다. 장기적으로 좋은 관계가 될 수도 있다. GP는 아직 불만이지만.',
            resultSpeaker: { name: 'GP 이대표', emoji: '👔' },
      ...
      // 투심위 보류/탈락 시
      {
        ...
        choices: [
          ...
          },
          {
            ...
            effects: { bossGaze: -5 },
            result: '집요하다. 이게 미덕인지 고집인지는 결과가 말해줄 것이다.',
            flags: ['retry_ic'],
          },
        ],
